...
PythonReporteEspecial = "./src/python/ReporteEspecialDHL.py";
DescargaReporteEspecial = './src/database/';
/*
PythonReporteEspecial = "./python/ReporteEspecialDHL.py";
DescargaReporteEspecial = './database/';
*/
...
especialesController.reporteNominaDHL = (req, res) => {
    ...
    if(data_1 !== undefined && data_1 !== null && data_2 === undefined || data_2 === null || data_2 === "" && data_3 === undefined)
    {
        ...
        estado = 1;
        process = spawn('python',[PythonReporteEspecial,estado,data_0,data_1]);
    }
    else if(data_1 !== undefined && data_1 !== null && data_2 !== undefined && data_2 !== null && data_3 === undefined || data_3 === null || data_3 === "")
    {
        estado = 2;
        process = spawn('python',[PythonReporteEspecial,estado,data_0,data_1,data_2]);
    }   
    else if(data_1 !== undefined && data_1 !== null && data_2 !== undefined && data_2 !== null && data_3 !== undefined && data_3 !== null)
    {
        estado = 3;
        process = spawn('python',[PythonReporteEspecial,estado,data_0,data_1,data_2,data_3]);
    }
    if(estado != 0){
...
especialesController.reporteNominaResponseDocument = (req, res) => {
    res.download(DescargaReporteEspecial+Lista_nombres[0]); 
    setTimeout(() => {fs.unlinkSync(DescargaReporteEspecial+Lista_nombres[0]);},"100")
}
// Función descargar Archivo reporte horizontal
especialesController.reporteNominaResponseDocument2 = (req, res) => {
    res.download(DescargaReporteEspecial+Lista_nombres[1]); 
    setTimeout(() => {fs.unlinkSync(DescargaReporteEspecial+Lista_nombres[1]);},"100")
}
// Función descargar Archivo reporte horizontal
especialesController.reporteNominaResponseDocument3 = (req, res) => {
    res.download(DescargaReporteEspecial+Lista_nombres[2]); 
    setTimeout(() => {fs.unlinkSync(DescargaReporteEspecial+Lista_nombres[2]);},"100")
}
// Exportar módulo

# Plantillas
DirectoryPlantillaLiquidacion = "./src/database/Liquidacion.xlsx"
DirectoryPlantillaNovedades = "./src/database/Novedades.xlsx"
DirectoryPlantillaTerceros = "./src/database/Terceros.xlsx"

# Json
DirectoryObtenerEmpresasLQ = "./src/database/VariablesEntornoLQ.json"
DirectoryObtenerEmpresasReLQ = "./src/database/VariablesEntornoReLQ.json"

# Reportes
DirectoryReporteHorizontal = "./src/database/"

...
import sys
from Directories.Directory import DirectoryReporteTxt

# Función principal para procesar el archivo TXT
def procesarTXTSS(NombreTemporal,Anio,Mes,Grupo):
    ...
    if(df1.empty):
        ...
        file_name = open(DirectoryReporteTxt+NombreTXT_ + ".txt", "w+")
        Texto_ = ""
